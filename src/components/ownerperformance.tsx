        ...
        <>
          <div className="grid grid-cols-2 gap-3">
            ...
            <Card className="p-4">
              ...
              <p className="text-[11px] text-muted-foreground">
                All-time {Number(s.lifetime_rating ?? 0).toFixed(1)} ({s.lifetime_reviews})
              </p>
            </Card>
            <Card className="p-4">
              ...
              <p className="text-[11px] text-muted-foreground">
                {s.staff_pending > 0 ? `${s.staff_pending} pending · ` : ""}
                {s.feedback_new} new messages
              </p>
            </Card>
          </div>
          ...
          <Card className="p-4">
            ...
            <p className="mt-1 text-[11px] text-muted-foreground">
              Tips go 100% to the staff member. Moybirr never touches them.
            </p>
          </Card>
